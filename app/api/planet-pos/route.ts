    ...
    const response = await axios.get(
      'https://ssd.jpl.nasa.gov/api/horizons.api',
      {
        params: {
          ...
          STEP_SIZE: '1m', // One-minute interval
          // OUT_UNITS: 'KM-D',
          ...
          ELM_LABELS: 'YES', // Labeling of osculating elements (NO, YES)
          // TLIST: 'none', // List of discrete output times (JD, MJD, CAL)
          // TLIST_TYPE: 'JD', // Type of time in TLIST (JD, MJD, CAL)
          QUANTITIES: '1', // Desired output quantity option codes
          VEC_TABLE: '1' // Vector table format
...
// TODO: You should pull out the segment XYZ segment,
// then somehow manage to subtract coords of orbit centre from them
